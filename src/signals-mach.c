...
#define THREAD_STATE MACHINE_THREAD_STATE
#define THREAD_STATE_COUNT MACHINE_THREAD_STATE_COUNT
...
#define HOST_EXCEPTION_STATE_COUNT ARM_EXCEPTION_STATE_COUNT
#endif
